		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="main_nav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" href="#" id="nd-inst" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Especialidades</a>
						<div class="dropdown-menu" aria-labelledby="nd-inst">
							<a class="dropdown-item" href="especialidades_cardiologica.php">CARDIOLOGICA</a>
							<a class="dropdown-item" href="especialidades_medicas.php">MÉDICAS</a>
						</div>
					</li>
