	...
	<ul class="list-fast-service">
		<li>
			<div class="box-service" style="background-color: #2196F3">
				...
				<a href="pacientes_visitas.php" class="btn btn-outline-light">SAIBA MAIS</a>
			</div>
		</li>
		<li>
		...
		<li>
			<div class="box-service" style="background-color: #1976D2">
				...
				<!-- <span class="row m-2" style="align-items: center;">
					<span class="col-md-6">
						<img class="img-fluid" src="images/logo-sus.png" alt="logo-sus">
					</span>
					<span class="col-md-6">
						<img class="img-fluid" src="images/logo-iasep.png" alt="logo-iasep">
					</span>
				</span> -->
